...
The first call creates MetaInfo_figures_checklist_v02.xlsx; subsequent calls append /
...
DEFAULT_PATH = r"Z:\Denys_nanoPhos\PRIDE\MetaInfo_figures_checklist_v02.xlsx"


def dump_panel(df: pd.DataFrame, sheet: str, path: str = DEFAULT_PATH,
               index: bool = False) -> None:
    """Write `df` to `sheet` in the MetaInfo v02 workbook (create or replace the sheet)."""
